...
// Tests to confirm that a circle can be correctly rendered
describe("Circle", () => {
...
// Tests to confirm that a triangle can be correctly rendered
describe("Triangle", () => {
  ...
  // Tests to confirm that a square can be correctly rendered
  describe("Square", () => {
    test("should render svg for a green polygon element", () => {
      const expectedSvg =
